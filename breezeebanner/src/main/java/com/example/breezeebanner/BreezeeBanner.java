...
public class BreezeeBanner extends RelativeLayout {
    ...
    private ArrayList<Object> oldimgPaths;
    ...
    private void initView(ArrayList<Object> imgPaths) {
        if (viewPager == null) {
    ...
    private boolean ifSamePaths(ArrayList<Object> paths) {
        for (int i = 0; i < paths.size(); i++) {
            if (oldimgPaths.get(i) != paths.get(i)) {
                return false;
            }
        }
        return true;
